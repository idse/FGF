    function [P,xi,Pstd] = radialPositive(stats, condi, meta, combos, options)
    ...
    if options.edgeDistance
        legend(legendstr,'FontSize',fs-10,'Location','NorthEast');
    else
        legend(legendstr,'FontSize',fs-10,'Location','NorthWest');
    end
    axis square
    fgc = 'k';
    bgc = 'w';
