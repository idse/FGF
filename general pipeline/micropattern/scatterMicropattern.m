...
for conditionIdx = options.conditionIdx
    ...
    for comboi = 1:numel(channelCombos)
        ...
        if ~options.minimal && options.title
        ...
        if ~options.minimal 
            ...
            if options.showThreshold(channelIdx(1)) && options.showThreshold(channelIdx(2)) 
                text(xmin(1) + (xthresh(1) - xmin(1))/2, xmin(2) + (xthresh(2)-xmin(2))/2, [num2str(nn,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va);
                text(xmin(1) + (xthresh(1) - xmin(1))/2, xthresh(2) + (xmax(2) - xthresh(2))/2, [num2str(pn,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va)
                text(xthresh(1) + (xmax(1) - xthresh(1))/2, xmin(2) + (xthresh(2)-xmin(2))/2, [num2str(np,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va)
                text(xthresh(1) + (xmax(1) - xthresh(1))/2, xthresh(2) + (xmax(2) - xthresh(2))/2, [num2str(pp,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va)
            elseif options.showThreshold(channelIdx(1)) && ~options.showThreshold(channelIdx(2)) 
                text(xmin(1) + (xthresh(1)-xmin(1))/2, xthresh(2), [num2str(nn + pn,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va);
                text(xthresh(1) + (xmax(1) - xthresh)/2, xthresh(2), [num2str(np + pp,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va)
            elseif options.showThreshold(channelIdx(2)) && ~options.showThreshold(channelIdx(1)) 
                text(xthresh(1), xthresh(2)/2, [num2str(nn + np,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va);
                text(xthresh(1), xthresh(2)  + (xmax(2) - xthresh(2))/2, [num2str(pn + pp,formatspec) '%'],'FontSize',pfs,'Color',fc,'FontWeight', 'bold','Background',bg,'HorizontalAlignment','center','VerticalAlignment',va)
            end
...
elseif strcmp(options.imageType,'Disordered')
    results.dataTable = table(x{1},x{2},x{3}, density,'VariableNames', [meta.channelLabel(channelIdx), 'density']);
end
